...
import { editPantryGrocery } from '../../../services/groceries';
...
export const PantryEditGrocery = ({grocery, groceries, setGroceries})=> {
    ...
    const onEdit = () => {
      ...
      const onEditSubmit = async (e) => {
        e.preventDefault()  
        const newGrocery = await editPantryGrocery(grocery.id, itemName);
